...
class SpaceUploaderLoginSignupView extends StatefulWidget {
  ...
  @override
  _SpaceUploaderLoginSignupViewState createState() => _SpaceUploaderLoginSignupViewState();
}

class _SpaceUploaderLoginSignupViewState extends State<SpaceUploaderLoginSignupView> {
  ...
  Future<void> _login() async {
    try {
      ...
      // Navigate to SpaceUploaderProfileScreen on success
      _navigateToSpaceUploaderProfileScreen(userCredential.user!.email!);
    } catch (e) {
  ...
  void _navigateToSpaceUploaderProfileScreen(String email) {
    Get.off(() => SpaceUploaderProfileScreen(email: email));
  }
